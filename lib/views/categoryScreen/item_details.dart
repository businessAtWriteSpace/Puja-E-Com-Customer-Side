              ...
              child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      ).box.height(60).padding(EdgeInsets.symmetric(horizontal: 16)).color(Colors.grey.shade500).make(),
                          ...
                          children: [
                                ...
                                Row(
                                  children: List.generate(data['p_colors'].length,
                                          (index) => Stack(
                                            ...
                                            children: [
                                              VxBox().size(40, 40).roundedFull.color(Color(data['p_colors'][index]).withOpacity(1.0))
                                                  .margin(EdgeInsets.symmetric(horizontal:4)).border(color: Colors.black)
                                                  .make().onTap(() {
                                                    controller.changeColorIdx(index);
                                              }),
                                              Visibility(
                                                visible: index==controller.colorIdx.value,
                                ...
                                Obx(() =>
                                  Row(
                                    children: [
                                      ...
                                      "(${data['p_quantity']} available)".text.color(Colors.grey.shade700).make(),
                                    ],
                                  ),
                                ),
                              ],
                            ...
                            Row(
                              children: [
                                SizedBox(
                                  width: 100,
                                  child: "Total: ".text.color(Colors.grey.shade700).make(),
                                ),
                      ...
                      20.heightBox,
                      produmayl.text.fontFamily(bold).size(16).color(darkFontGrey).make(),
                     10.heightBox,
              ...
              onPress: () {
                if(controller.quantity.value>0){
                  controller.addToCart(
                    color: data['p_colors'][controller.colorIdx.value],
                    context: context,
                  ...
                  VxToast.show(context, msg: "Please select minimum 1 product");
                }
              },
